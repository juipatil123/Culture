...
const TeamLeaderProfile = ({ userData }) => {
                ...
                <div className="col-lg-4 mb-4">
                    ...
                    <div className="card border-0 shadow-sm h-100">
                        <div className="card-body text-center py-5">
                            ...
                            <p className="text-muted mb-3">{userData.role || 'Team Leader'}</p>

                            <div className="d-flex justify-content-center gap-2 mb-4">
                                <button className="btn btn-primary px-4">Edit Profile</button>
                                <button className="btn btn-outline-secondary px-3"><i className="fas fa-camera"></i></button>
                            </div>
                            ...
                            <div className="text-start">
                                ...
                                <div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <span>{userData.joinDate ? new Date(userData.joinDate).toLocaleDateString() : 'N/A'}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form>
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input type="email" className="form-control" defaultValue={userData.email} disabled />
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label text-muted small">Phone Number</label>
                                        <input type="tel" className="form-control" defaultValue={userData.phone || ''} placeholder="+1 234 567 890" />
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label text-muted small">Department</label>
                                        <select className="form-select" defaultValue={userData.department || 'Web Development'}>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <textarea className="form-control" rows="4" placeholder="Tell us about yourself..." defaultValue={userData.bio || ''}></textarea>
                                    </div>
                                </div>
